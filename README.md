...
After-hours multi-agent investment committee — a proof of concept for AI-powered desk research and committee debate. **Educational purposes only**; not intended for real trading or investment.
...
Before you can run THE FLOOR, you'll need to install it and set up your API keys. These steps are common to both the full-stack web application and command line interface.
...
You can run THE FLOOR directly via terminal.
...
You can also specify a `--ollama` flag to run THE FLOOR using local LLMs.
...
The recommended way to run THE FLOOR is through the web application.

Please see detailed instructions [here](./app/README.md).
...
If you have a feature request, please open an [issue](https://github.com/AuthByte/the-floor2/issues) and tag it `enhancement`.
