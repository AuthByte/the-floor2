...
from app.backend.routes.hedge_fund import router as hedge_fund_router, public_router as hedge_fund_public_router
...
from app.backend.routes.personas import router as personas_router
from app.backend.routes.public import router as public_router
from app.backend.routes.billing import router as billing_router
...
api_router.include_router(hedge_fund_public_router, tags=["hedge-fund-public"])
