@echo off
REM THE FLOOR Web Application Setup and Runner (Windows)
...
echo.
echo %INFO% THE FLOOR Web Application Setup
...
REM Start services
echo %INFO% Starting the THE FLOOR web application...
...
echo.
echo %SUCCESS% THE FLOOR web application is now running
