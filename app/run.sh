...
# THE FLOOR Web Application Setup and Runner
...
start_services() {
    print_status "Starting the THE FLOOR web application..."
    ...
    echo ""
    print_success "🚀 THE FLOOR web application is now running!"
...
main() {
    echo ""
    print_status "🚀 THE FLOOR Web Application Setup"
...
if [[ "$1" == "--help" ]] || [[ "$1" == "-h" ]]; then
    echo "THE FLOOR Web Application Setup and Runner"
    echo ""
    echo "Usage: ./run.sh"
    echo ""
