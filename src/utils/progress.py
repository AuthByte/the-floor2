...
class AgentProgress:
    ...
    def update_status(
        ...
        *,
        ...
        if clear_analysis:
            self.agent_status[agent_name].pop("analysis", None)
        elif analysis is not None:
            self.agent_status[agent_name]["analysis"] = analysis
        if signal is not None:
            self.agent_status[agent_name]["signal"] = signal
        if confidence is not None:
            self.agent_status[agent_name]["confidence"] = confidence
        if thesis_summary is not None:
            self.agent_status[agent_name]["thesis_summary"] = thesis_summary
        ...
        current_analysis = info.get("analysis")
